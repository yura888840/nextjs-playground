...
export default function Home() {
  ...
  return <main><header><span className="mark">N</span><span>My first release</span><span className="tag">NEXT.JS</span></header>
    ...
    <p className="note">The counter runs in your browser and resets when you reload the page.</p></section><footer><span>Next.js / React / JavaScript</span><Link href="/tasks" style={{ color: "#e4ff69" }}>Open task manager →</Link></footer></main>;
}
